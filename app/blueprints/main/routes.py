...
#     all_pokedex = Pokedex.query.all()
#     for user in all_users:
        
#         pokemon = Pokedex.query.filter_by(user_id=user.id)
#         user_pokemon.append(pokemon)


#     # all_pokemon=all_users.filter(pokemon.id).all()
#     return render_template('pokemon_battle.html.j2', users=user_pokemon)
...
def pokemon_battle():
    ...
    # all_pokemon=all_users.filter(pokemon.id).all()
    return render_template('pokemon_battle.html.j2', all_users=all_users)
